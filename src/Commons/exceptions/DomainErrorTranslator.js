...
DomainErrorTranslator._directories = {
  ...
  "ADD_COMMENT_LIKE.NOT_CONTAIN_NEEDED_PROPERTY": new InvariantError(
    "tidak dapat menyukai karena properti yang dibutuhkan tidak ada"
  ),
  "ADD_COMMENT_LIKE.NOT_MEET_DATA_TYPE_SPECIFICATION": new InvariantError(
    "tidak dapat menyukai karena tipe data tidak sesuai"
  ),
};

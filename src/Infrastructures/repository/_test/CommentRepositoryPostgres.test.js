...
describe("CommentRepositoryPostgres", () => {
  ...
  describe("verifyCommentOwner function", () => {
    it("should return Authorization when owner is not the same as the payload", async () => {
      await UsersTableTestHelper.addUser({});
      await ThreadsTableTestHelper.addThread({});
      ...
      await expect(
        commentRepositoryPostgres.verifyCommentOwner("comment-123", "user-1234")
  ...
  describe("deleteCommmentById function", () => {
